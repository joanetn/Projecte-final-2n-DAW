...
const Home = () => {
    ...
    const HeroSection = () => (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden hero-gradient-bg">
            ...
            {/* Elements decoratius amb icones flotants */}
            ...
            <div className="relative z-10 container mx-auto px-4 py-20">
                <div className="max-w-4xl mx-auto text-center">
                    {/* Etiqueta distintiva amb animació */}
                    ...
                    {/* Títol principal amb efecte glow */}
                    ...
                    {/* Indicadors de confiança amb animació */}
    ...
    // Secció de benvinguda per a usuaris autenticats
    ...
    return (
        <div className="min-h-screen">
            {/* Secció Hero / Benvinguda */}
            {isLoggedIn ? <WelcomeSection /> : <HeroSection />}

            {/* Secció: Què és aquesta plataforma? */}
            ...
            {/* Secció: Com funciona? - Flux explicat */}
            ...
            {/* Secció: Funcionalitats principals */}
            ...
            {/* Secció: Estadístiques de la plataforma */}
            ...
            {/* Secció: Testimonis - Només per a usuaris no autenticats */}
            {!isLoggedIn && (
                <section className="py-20 section-gradient-blue relative overflow-hidden">
                    {/* Decoració de fons */}
            ...
            {/* Secció CTA - Només per a usuaris no autenticats */}
            {!isLoggedIn && (
            ...
            {/* Secció: Accions ràpides per a usuaris autenticats */}
            {isLoggedIn && (
